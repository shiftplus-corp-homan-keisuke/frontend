...
graph TD
    ...
    D --> D1[高度な型機能<br/>状態管理ライブラリ<br/>ポートフォリオ完成]
...
| **10** | 高度機能期       | 高度な型機能                      | 条件型、infer、マップ型、テンプレートリテラル型 | 6 時間   | 型レベルプログラミングライブラリ |
| **11** | 高度機能期       | TypeScript + 状態管理ライブラリ   | Zustand、Redux Toolkit、型安全な状態設計 | 6 時間   | 状態管理アプリケーション |
| **12** | 高度機能期       | ポートフォリオ完成                | 総合プロジェクト、デプロイ、学習成果まとめ | 7 時間   | 完成ポートフォリオサイト |
...
#### [Step 11: TypeScript + 状態管理ライブラリ](./Step11_TypeScript状態管理ライブラリ.md)
