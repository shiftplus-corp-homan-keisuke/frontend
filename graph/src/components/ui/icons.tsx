...
export const LineChart: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const BarChart3: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 13h4v8H3v-8zM10 9h4v12h-4V9zM17 5h4v16h-4V5z" />
  </svg>
);
