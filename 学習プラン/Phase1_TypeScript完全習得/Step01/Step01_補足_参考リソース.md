...
## 📋 目次
1. [学習記録テンプレート](#学習記録テンプレート)
2. [公式ドキュメント](#公式ドキュメント)
3. [学習サイト](#学習サイト)
4. [オンラインツール](#オンラインツール)
5. [コミュニティ・質問サイト](#コミュニティ質問サイト)
6. [推奨書籍](#推奨書籍)
7. [YouTube チャンネル](#youtube-チャンネル)
8. [便利なライブラリ・ツール](#便利なライブラリツール)
...
### TypeScript学習ジャーナルの作成方法

学習の進捗と理解度を記録するためのテンプレートです。日々の学習内容を整理し、振り返りに活用してください。
...
### [日付] - Step01: JavaScript復習とTypeScript導入
...
- **エラー**: `Type 'string' is not assignable to type 'number'`
  ...
  **コード例**: 
  ```typescript
  let age: number = 25; // string ではなく number
  ```
```