...
- [ ] **インターフェースの基本概念**: 定義方法と構造的型付けの理解
- [ ] **オプショナルプロパティ**: `?` を使った任意項目の適切な設計
- [ ] **読み取り専用プロパティ**: `readonly` による不変性の保証
- [ ] **基本的なインターフェース設計**: 実用的なオブジェクト型の作成

### 次Session準備確認

- [ ] **練習問題の完了**: Session1の全練習問題を解答できた
- [ ] **基本概念の理解**: インターフェースの重要性と使用場面を説明できる
- [ ] **実装経験の獲得**: 基本的なインターフェースを自力で作成できる
- [ ] **Session2への準備**: 継承の概念について予習の準備ができた

### ⚠️ よくある間違いと注意点

**インターフェース設計での注意点:**
- ❌ **過度に詳細なインターフェース**: 50個以上のプロパティを持つ巨大なインターフェース
- ✅ **適切な分割**: 関連するプロパティごとに小さなインターフェースに分割

**オプショナルプロパティの注意点:**
- ❌ **必須項目をオプショナルにする**: `name?`, `id?` など絶対に必要な項目
- ✅ **適切なオプショナル使用**: 任意項目や条件によって存在しない項目のみ

**読み取り専用プロパティの注意点:**
- ❌ **変更可能な項目をreadonlyにする**: ユーザー名やメールアドレスなど
- ✅ **適切なreadonly使用**: ID、作成日時、計算結果など変更されるべきでない項目
